...
var $author$project$PhotoGroove$initialModel = {chosenSize: $author$project$PhotoGroove$Small, status: $author$project$PhotoGroove$Loading};
...
var $author$project$PhotoGroove$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				if (msg.a.$ === 'Ok') {
					var responseString = msg.a.a;
					var _v3 = A2($elm$core$String$split, ',', responseString);
					if (_v3.b) {
						var urls = _v3;
						var firstPhoto = urls.a;
						var photos = A2($elm$core$List$map, $author$project$PhotoGroove$Photo, urls);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									status: A2($author$project$PhotoGroove$Loaded, photos, firstPhoto)
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: $author$project$PhotoGroove$Errored('Error retrieving Photos')
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$PhotoGroove$SelectThumbnailSize = function (a) {
	return {$: 'SelectThumbnailSize', a: a};
};
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$PhotoGroove$SelectThumbnailSize(size)),
...
var $author$project$PhotoGroove$viewLoaded = F3(
	function (chosenSize, photos, selectedUrl) {
		return _List_fromArray(
			[
				A2(
				$elm$html$Html$h1,
		...
		function () {
			...
			switch (_v0.$) {
				...
				case 'Loaded':
					...
					return A3($author$project$PhotoGroove$viewLoaded, model.chosenSize, photos, selectedUrl);
				default:
					var err = _v0.a;
					return _List_fromArray(
						[
