...
var $author$project$PhotoGroove$initialModel = {activity: '', chosenSize: $author$project$PhotoGroove$Small, hue: 5, noise: 5, ripple: 5, status: $author$project$PhotoGroove$Loading};
	...
	F2(
		function (url, size) {
			return A2(
				...
				$elm$core$Result$Ok('Default title'),
				A2(
					$elm$core$Result$map,
					function ($) {
						return $.title;
...
var $author$project$PhotoGrooveTests$slidersTest = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					$author$project$Test$Runner$Node$check($author$project$PhotoGrooveTests$slidersTest),
...
var pipeFilename = "/tmp/elm_test-219775.sock";
var net = require('net'),
